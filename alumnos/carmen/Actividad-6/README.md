...
[API Users](https://www.youtube.com/).

Repositorio del backend (autolink): https://github.com/org/backend-usuarios
## Pasos
1. Crear usuario con ``curl`` y cuerpo JSON (ver guía).

    Consulta la [guía de uso de curl](https://www.youtube.com/) para más ejemplos.
2. Verificar respuesta **200 OK** y campos obligatorios.
## Evidencias
![Diagrama de arquitectura del módulo](arquitectura.png)
![Respuesta 200 OK](200.png)
