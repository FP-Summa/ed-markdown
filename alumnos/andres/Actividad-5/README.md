...
Usa los siguientes accesos rápidos: [Ir a Descargas](descargas) · [Ir a Documentación](documentacion)
___
## Descargas
- **Android Studio** (inline): [Descarga]()
- **Organización del curso** (autolink GFM): https://github.com/FP-Summa
![Acerca de Android Studio](https://techterms.com/img/lg/android_841.png)
## Documentación
