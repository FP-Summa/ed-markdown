...
## Resumen
Este módulo gestiona altas de usuario mediante el endpoint **`POST`** descrito aquí:<br>
[API Users](API-Users).<br>
Repositorio del backend (autolink): https://github.com/org/backend-usuarios
## Pasos
1. Crear usuario con `curl` y cuerpo JSON (ver guía).<br>
Consulta la [guía de uso de curl](guía-de-uso-de-curl) para más ejemplos.
