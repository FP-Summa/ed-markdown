...
1. Revisar requisitos y limitar alcance a una demo mínima. <br>Este punto aclara **qué entra** y **qué no entra** en el sprint, para evitar confusiones y cambios de última hora.

2. Preparar entorno de desarrollo. <br>
...
CI : Integración continua: ejecuciones automáticas para **build** y pruebas.<br>
