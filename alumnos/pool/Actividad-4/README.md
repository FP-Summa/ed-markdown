...
1. Registro de usuario.<br>
Recoger **email** y **password**, validar formato y guardar `password_hash` (no se 
...
Hash : Función **unidireccional** para almacenar contraseñas de forma segura.<br>
